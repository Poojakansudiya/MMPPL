...
{
    public partial class DispatchCollectionView : XtraUserControl
    {
        public DispatchCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            ...
            var fluentAPI = mvvmContext.OfType<MMPPL.ViewModels.DispatchCollectionViewModel>();
