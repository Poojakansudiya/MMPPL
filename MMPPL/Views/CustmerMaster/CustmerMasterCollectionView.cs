...
{
    public partial class CustmerMasterCollectionView : XtraUserControl
    {
        public CustmerMasterCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            ...
            var fluentAPI = mvvmContext.OfType<MMPPL.ViewModels.CustmerMasterCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as MMPPL.CustmerMaster,
