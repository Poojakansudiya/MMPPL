...
{
    public partial class MicronMasterCollectionView : XtraUserControl
    {
        public MicronMasterCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            ...
            var fluentAPI = mvvmContext.OfType<MMPPL.ViewModels.MicronMasterCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as MMPPL.MicronMaster,
