...
{
    public partial class LabelPrintingCollectionView : XtraUserControl
    {
        public LabelPrintingCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            ...
            var fluentAPI = mvvmContext.OfType<MMPPL.ViewModels.LabelPrintingCollectionViewModel>();
