...
{
    public partial class ColorMasterCollectionView : XtraUserControl
    {
        public ColorMasterCollectionView()
        {
            InitializeComponent();
        ...
        void InitBindings()
        {
            ...
            var fluentAPI = mvvmContext.OfType<MMPPL.ViewModels.ColorMasterCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as MMPPL.ColorMaster,
